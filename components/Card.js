  ...
  return (
    <div className="max-w-sm mx-auto bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
      ...
      <div className="p-5">
        ...
        <p className="italic mt-2 text-sm text-gray-600">{address}</p>
        <button onClick={openModal} className="mt-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
          Read more
        </button>
      </div>
